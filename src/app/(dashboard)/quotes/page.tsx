                ...
                <tr key={quote.id} onClick={() => router.push(`/quotes/${quote.id}`)} className="cursor-pointer hover:bg-brand-50/50">
                  ...
                  <td>
                    <div className="flex items-center gap-1">
                      ...
                      <button onClick={(e) => { e.stopPropagation(); if(confirm('Bạn có chắc muốn xóa báo giá này?')) fetch(`/api/quotes/${quote.id}`, {method: 'DELETE'}).then(fetchQuotes) }} className="p-1.5 hover:bg-red-50 text-red-600 rounded" title="Xóa báo giá">
